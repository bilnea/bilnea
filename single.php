		...
		<div id="primary" class="main-row">
			<div id="content" role="main" class="span8 offset2">
				<article class="post">
					...
					echo do_shortcode(preg_replace_callback("/{{b_share(-)?([a-zA-Z]+)?}}/", "b_f_i_share", preg_replace_callback("/{{b_image-([0-9a-zA-Z]+)}}/", "b_f_i_image", str_replace($var_shortcodes, $var_replace, b_f_option('b_opt_blog-content-single-'.$b_g_language)))));
