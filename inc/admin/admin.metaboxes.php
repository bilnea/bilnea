...
if (!function_exists('b_f_page_add_template_metabox')) {
	...
	function b_f_page_add_template_metabox($post) {
		...
		// Variables globales
		wp_nonce_field('page_template_metabox', 'page_template__metabox_nonce'); ?>

		<h4 style="margin-bottom: 0;">Cabecera de página</h4>
		<p style="margin-top: 6px;">
			<input type="checkbox" name="b_o_page_metabox_top_bar" value="1" <?php echo (b_f_page_get_metabox('b_o_page_metabox_top_bar') == 1 || !isset($_GET['post'])) ? 'checked' : ''; ?>>
			<label for="b_o_page_metabox_top_bar">Barra superior</label>
			<br />
			<input type="checkbox" name="b_o_page_metabox_header" value="1" <?php echo (b_f_page_get_metabox('b_o_page_metabox_header') == 1 || !isset($_GET['post'])) ? 'checked' : ''; ?>>
			<label for="b_o_page_metabox_header">Zona principal cabecera de página</label>
		</p>
		<hr />
		<h4 style="margin-bottom: 0;">Pie de página</h4>
		<p style="margin-top: 6px;">
			<input type="checkbox" name="b_o_page_metabox_footer" value="1" <?php echo (b_f_page_get_metabox('b_o_page_metabox_footer') == 1 || !isset($_GET['post'])) ? 'checked' : ''; ?>>
			<label for="b_o_page_metabox_footer">Zona principal pie de página</label>
			<br />
			<input type="checkbox" name="b_o_page_metabox_bottom_bar" value="1" <?php echo (b_f_page_get_metabox('b_o_page_metabox_bottom_bar') == 1 || !isset($_GET['post'])) ? 'checked' : ''; ?>>
			<label for="b_o_page_metabox_bottom_bar">Barra inferior</label>
		</p>
		<hr />
		<h4 style="margin-bottom: 0;">Menú móvil</h4>
		<p style="margin-top: 6px;">
			<input type="checkbox" name="b_o_page_mobile_menu" value="1" <?php echo (b_f_page_get_metabox('b_o_page_mobile_menu') == 1 || !isset($_GET['post'])) ? 'checked' : ''; ?>>
			<label for="b_o_page_mobile_menu">Menú móvil</label>
			<br />
			<input type="checkbox" name="b_o_page_mobile_bar" value="1" <?php echo (b_f_page_get_metabox('b_o_page_mobile_bar') == 1 || !isset($_GET['post'])) ? 'checked' : ''; ?>>
...
if (!function_exists('b_f_page_save_template_metabox')) {
	...
	function b_f_page_save_template_metabox($post_id) {
		...
		if (!isset($_POST['page_template__metabox_nonce']) || ! wp_verify_nonce($_POST['page_template__metabox_nonce'], 'page_template_metabox')) return;
		...
		if (isset($_POST['b_o_page_metabox_top_bar']))
			...
			update_post_meta($post_id, 'b_o_page_metabox_top_bar', null);
		...
		if (isset($_POST['b_o_page_metabox_header']))
			...
			update_post_meta($post_id, 'b_o_page_metabox_header', null);
		...
		if (isset($_POST['b_o_page_metabox_footer']))
			...
			update_post_meta($post_id, 'b_o_page_metabox_footer', null);
