	...
	<form action="options.php" method="post" id="bilnea">
		...
		<div id="bilset">
			...
			<div class="lateral">
				...
				<h3 <?php if (b_f_option('tab') == 2) { echo 'class="activo"'; }?>>Redes sociales</h3>
				<h3 <?php if (b_f_option('tab') == 3) { echo 'class="activo"'; }?>>Desarrollo</h3>
				<h3 <?php if (b_f_option('tab') == 4) { echo 'class="activo"'; }?>>Buscador</h3>
				<h3 <?php if (b_f_option('tab') == 5) { echo 'class="activo"'; }?>>Servicios externos</h3>
				<h3 <?php if (b_f_option('tab') == 6) { echo 'class="activo"'; }?>>Estilos tipográficos</h3>
				<h3 <?php if (b_f_option('tab') == 7) { echo 'class="activo"'; }?>>Adaptación responsive</h3>
				<h3 <?php if (b_f_option('tab') == 8) { echo 'class="activo"'; }?>>Logotipo e iconos</h3>
				<h3 <?php if (b_f_option('tab') == 9) { echo 'class="activo"'; }?>>Cabecera</h3>
				<h3 <?php if (b_f_option('tab') == 10) { echo 'class="activo"'; }?>>Pie de página</h3>
				<h3 <?php if (b_f_option('tab') == 11) { echo 'class="activo"'; }?>>Blog</h3>
				<h3 <?php if (b_f_option('tab') == 12) { echo 'class="activo"'; }?>>Textos legales</h3>
				<h3 <?php if (b_f_option('tab') == 13) { echo 'class="activo"'; }?>>Redirecciones y SEO</h3>
				<h3 <?php if (b_f_option('tab') == 14) { echo 'class="activo"'; }?>>Copias de seguridad</h3>
				<h3 <?php if (b_f_option('tab') == 15) { echo 'class="activo"'; }?>>Ayuda</h3>
				<h3 <?php if (b_f_option('tab') == 16) { echo 'class="activo"'; }?>>Créditos</h3>
			</div>
			...
			<div class="central">
				...
				<div <?php if (b_f_option('tab') == 2) { echo 'class="activo"'; }?> id="tab2">
					<?php include('panel/panel.social.php'); ?>
				</div>
				...
				<!-- Ayuda -->
				<div <?php if (b_f_option('tab') == 15) { echo 'class="activo"'; } ?> id="tab15">
					<?php include('panel/panel.help.php'); ?>
				</div>

				<!-- Créditos -->
				<div <?php if (b_f_option('tab') == 16) { echo 'class="activo"'; } ?> id="tab16">
