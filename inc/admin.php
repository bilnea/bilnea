				...
				<div <?php if (!isset($opt['pestanya']) || $opt['pestanya'] == 1) { echo 'class="activo"'; }?> id="tab1">
					<div class="main-info">
						...
						<div style="text-align: center; margin-bottom: 20px; font-size: 11px; font-style: italic; line-height: 15px;">
							...
							<br />
							&reg; 2015 bilnea. Versión 1.1 (febrero 2016).
							<br /><br />
						...
						if (!empty($lng)) {
							...
							<div class="notice" style="font-size: 12px;">
								...
								foreach ($lng as $l) {
									...
									<br />
									<label for="bilnea_settings[b_opt_legal-url-<?= $l['language_code']?>]"><?php echo $sitepress->language_url($l['language_code']); ?></label>
									<input style="font-size: 12px; -webkit-transform: translate(-5px, 1px); -moz-transform: translate(-5px, 1px); -ms-transform: translate(-5px, 1px); -o-transform: translate(-5px, 1px); transform: translate(-5px, 1px);" type='text' class="aurl" name='bilnea_settings[b_opt_legal-url-<?= $l['language_code']?>]' value='<?php echo $opt['b_opt_legal-url-'.$l['language_code']]; ?>'>
									<?php
									$int++;
								}
								?>
