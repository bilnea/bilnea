...
$txt .= '<h4>Cookies publicitarias</h4>'."\n";
$txt .= '<p>Son aquéllas que, bien tratadas por nosotros o por terceros, permiten gestionar eficazmente los espacios publicitarios de nuestro sitio web, adecuando el contenido del anuncio al contenido del servicio solicitado o al uso que realice de nuestra página web. Gracias a ella podemos conocer sus hábitos de navegación en internet y mostrarle publicidad relacionada con su perfil de navegación.</p>'."\n";
$txt .= '<h4>Otras cookies de terceros</h4>'."\n";
...
$txt .= '<li><a href="https://support.google.com/chrome/answer/95647?hl=es&amp;hlrm=es" target="_blank" rel="nofollow" title="Google Chrome">Google Chrome</a></li>'."\n";
$txt .= '<li><a href="http://support.mozilla.org/es/kb/cookies-informacion-que-los-sitios-web-guardan-en-?redirectlocale=en-US&amp;redirectslug=Cookies" target="_blank" rel="nofollow" title="Mozilla Firefox">Mozilla Firefox</a></li>'."\n";
$txt .= '<li><a href="http://help.opera.com/Windows/11.50/es-ES/cookies.html" target="_blank" rel="nofollow" title="Opera">Opera</a></li>'."\n";
$txt .= '<li><a href="http://support.google.com/android/?hl=es" target="_blank" rel="nofollow" title="">Android</a></li>'."\n";
$txt .= '<li><a href="http://www.windowsphone.com/es-ES/how-to/wp7/web/changing-privacy-and-other-browser-settings" target="_blank" rel="nofollow" title="">Windows Phone</a></li>'."\n";
...
if (b_f_option('active_cookies_lis') == 1) {
...
$txt .= '<h3>Aceptación de cookies</h3>'."\n";
